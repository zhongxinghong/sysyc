...
class Value {
  public:
    ...
    operator long long int() { long t; return (valid && (std::istringstream(str) >> t)) ? t : 0; }
    operator unsigned long long int() { unsigned long t; return (valid && (std::istringstream(str) >> t)) ? t : 0; }
