...
#ifndef __SYSYC_BACKEND_EEYORE_CODEGEN_H__
#define __SYSYC_BACKEND_EEYORE_CODEGEN_H__
...
namespace eeyore
{
class EeyoreCodeGenerator
{
public:
  EeyoreCodeGenerator(std::size_t tabsize, misc::Logger &logger) :
    tabsize(tabsize),
    logger(logger),
    indent(0),
    p_instseq(nullptr),
...
#endif // __SYSYC_BACKEND_EEYORE_CODEGEN_H__
