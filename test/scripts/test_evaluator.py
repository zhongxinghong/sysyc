...
OUTPUT_DIR = os.path.join(ROOT_DIR, "../output/test_evaluator/")
CMD = os.path.abspath(os.path.join(SYSYC_TEST_BIN_DIR, "./test-evaluator"))
SUFFIX = "eval"
...
def test_evaluator():
    ...
    for src_filepath, rel_dir in all_src:
        ...
        if src_filename in ['e08.sy', 'e09.sy']:
            continue
